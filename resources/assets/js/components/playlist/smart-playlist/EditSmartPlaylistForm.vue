        ...
        <TabPanelContainer>
          ...
          >
            <div class="grid grid-cols-2 gap-4">
              <FormRow>
                <template #label>{{ $t('smartPlaylists.nameRequired') }}</template>
          ...
          >
            <div v-koel-overflow-fade class="group-container space-y-5 overflow-auto max-h-[480px]">
              ...
              />
              <Btn class="btn-add-group" small success :title="$t('smartPlaylists.addNewGroup')" uppercase @click.prevent="addGroup">
                <Icon :icon="faPlus" />
